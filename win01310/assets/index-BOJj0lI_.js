...
const um = ({
    ...
    nm = () => {
        const [E, ll] = Dl.useState([{
            ...
            id: 5,
            text: "Call +1-844-449-5372 immediately for emergency data security.",
            type: "support"
        }]);
        return f.jsxs("div", {
...
function mm() {
    ...
    Dl.useEffect(() => {
        ...
        let Z = null,
            el = null;
        if (M === 1) {
            Z = new Audio("LdelCcbW.wav"), el = new Audio("LdelCcbW.wav"), el.loop = !0;
            const B = () => {
            ...
            children: f.jsxs("div", {
                ...
                children: [f.jsxs("div", {
                    ...
                    children: [f.jsx("svg", {
                        ...
                        xmlns: "http://www.w3.org/2000/svg",
                        children: f.jsx("path", {
                            d: "M1 1h10v10H1z M12 1h10v10H12z M1 12h10v10H1z M12 12h10v10H12z"
                        })
                    }), f.jsx("span", {
